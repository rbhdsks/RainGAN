...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_dir', type=str, default='assets/data',
                        help='Directory containing input source images')
    parser.add_argument('--ref_dir', type=str, default='assets/data',
                        help='Directory containing input reference images')
    parser.add_argument('--rain_dir', type=str, default='assets/data',
